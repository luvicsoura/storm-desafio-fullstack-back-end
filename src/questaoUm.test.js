...
describe('Questão Um', function () {
    ...
    it(
        'Dado uma array = [2, 7, 11, 15] e um alvo = 9, então a função deverá retornar [0, 1]',
        function () {
    ...
    it(
        'Dado uma array = [2, 11, 15, 7] e um alvo = 9, então a função deverá retornar [0, 3]',
        function () {
    ...
    it(
        'Dado uma array = [155, 20, 110, 70] e um alvo = 265, então a função deverá retornar [0, 2]',
        function () {
